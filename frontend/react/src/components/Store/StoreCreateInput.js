            ...
            <Fragment>
                <form onSubmit={ this.createStore }>
                    ...
                    <div className='store-creator-container'>
                        <p className='store-creator__title'><b>2/ Name:</b></p>
                    ...
                    <div className='store-creator-container'>
                        <p className='store-creator__title'><b>3/ Email:</b></p>                    
                    ...
                    <div className='store-creator-container'>
                        <p className='store-creator__title'><b>4/ Phone:</b></p>                
                    ...
                    <div className='store-creator-container'>
                        <p className='store-creator__title'><b>5/ Address:</b></p>                    
