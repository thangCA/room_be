...
import { handlePaymentOption } from './Modules/handle-payment-option';
...
class Order extends React.Component {
    constructor(props) {
        ...
        this.state = {            
            ...
            paymentOptionList: ['Cast', 'PayPal'],
            paymentOption: 'Cast', //PayPal,                                              
    ...
    handlePaymentOption(event) {
        handlePaymentOption(this, event);
    }
                ...
                <div className='order-inner'>
                    <div className='order-form-container'>
                        ...
                        <form onSubmit={ this.postOrderDetail }>
                            ...
                            <hr className='horizontal-line' />
                            <div style={{ display: 'flex', flexDirection: 'row', margin: '40px 0' }}>
                                <p><i><b>Choose a payment method: </b></i></p>
                                <select value={ this.state.paymentOption } onChange={ this.handlePaymentOption } style={{ width: '200px', height: '35px', margin: '0 40px', fontWeight: 'bold', color: '#c90016' }} className='select input input-none-border input-none-border--focus'>                                    
                                    {
                                        this.state.paymentOptionList.map(item =>
                                            <option>{item}</option>                                                
                                        )
                                    }
                                </select>
                            </div>
                                {
                                    ...
                                    <input 
                                        ...
                                        disabled
                                        value='Sending...'
                                        className='btn btn--hover order-detail-container'  
                                        style={{width: '200px', height: '35px', backgroundColor: '#ffc439', border: 'none', fontWeight: 'bold'}}                                              
                                    />:                                    
                                    <input 
                                        type='submit'
                                        value={ 'Order with ' + this.state.paymentOption }
