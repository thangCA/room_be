...
import flashSaleBannerBlack from '../../assets/img/promotion/flash-sale-banner-black.jpg'
                        ...
                        <div>
                            {
                                ...
                                <div className='shopping-wrapper'>                            
                                    ...
                                    <Link to={'/promotion/flash-sale'}><img alt='flash-sale-banner' src={ flashSaleBannerBlack } className='flash-sale-banner' /></Link>   
                                </div>:
                                <div>
