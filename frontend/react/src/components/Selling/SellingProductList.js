                ...
                <context.Consumer>
                    {
                        ...
                        <div className='selling-list-container'>
                            <div className='btn white-btn white-btn--hover' style={{ width: '100px' }} onClick={ this.props.showTable }><p><b>Back</b></p></div>
                            <p style={{ marginTop: '50px' }}><u><Link to={ `/product/detail/view/${ this.props.product._id }` } className='selling-list__product-link'><b>{this.props.product.name}</b></Link></u></p>                                                        
                            {
                                this.props.isShowConfirmingState ?
                                <Loading />:
                                null
                            }                                                       
                            ...
                            <hr />
                            <SellingOrderList order={ this.props.order } product={ this.props.product } />                                                                                                                                                                
                        </div>
                    }
                </context.Consumer>                
            </Fragment>
